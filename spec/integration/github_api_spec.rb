# NOTE: Temporarily commenting out to find a better approach, the below does not work with Travis CI because it does not have access to the specific database
# require 'spec_helper'
# require 'github_api'
